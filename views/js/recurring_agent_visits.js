...
$('#filter_link').click(function(){
	...
	var end_date   = $('#end_date').val();
     ...
     if(new Date(start_date).getTime() < new Date(end_date).getTime())
	 {
	   ...
	   window.location.assign("/show_filtered_recurring_agent_visits?start_date=" +start_date + "&end_date=" +end_date);
	 }
	 else
	 {
...
function show_orders(agent_code)
{   
        $.ajax({
			type:"GET",
			url:"/get_orders_from_agentcode",
